...
class AppController extends Controller
{
  ...
  public $helpers = array(
  		...
  		'Html' => array('className' => 'BootstrapUI.Html'),
  		'Form' => array('className' => 'BootstrapUI.Form'),
  		'Paginator' => array('className' => 'BootstrapUI.Paginator'),
      'Flash' => array('className' => 'BootstrapUI.Flash'),
  	);
