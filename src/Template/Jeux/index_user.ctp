  ...
  <table class="table table-striped">
      ...
      <tbody>
          ...
          <tr>
            <td>
              ...
              if (substr($this->request->here, -5)=='jeux/') {
                $link = $this->request->here.'index-user/'.$folder;
              }else {
                if (substr($this->request->here, -4) == 'jeux') {
                  $link = $this->request->here.'/'.'index-user/'.$folder;
                }else {
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
              <td >
                <a href="<?= $link_file.'/'.$jeu ?>"><span class="glyphicon glyphicon-download-alt"></span></a>
<span>&nbsp;&nbsp;</span>

                <a href="<?= $link_file.'/'.$jeu ?>"><?= $jeu ?></a>
