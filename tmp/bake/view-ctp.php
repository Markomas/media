...
<nav class="navbar navbar-default">
  <div class="container-fluid">
      <ul class="nav navbar-nav">
        ...
        <li><CakePHPBakeOpenTag= $this->Form->postLink(__('Supprimer <?= $singularHumanName ?>'), ['action' => 'delete', <?= $pk ?>], ['confirm' => __('Êtes vous sûr de vouloir supprimer # {0}?', <?= $pk ?>)]) CakePHPBakeCloseTag> </li>
